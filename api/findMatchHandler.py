...
class find_match(Resource):
    ...
    def get(self):
        ...
        client_credentials_manager = SpotifyClientCredentials() #<- insert credentials here
        ...
        if candidate_vec_dict == False:
            ...
            return {
                'topTwoMatches': [['None', -1], ['None', -1]], #there are no matches
            }
        ...
        #name = "Debbie" #! need to get name from args 
        for i in range(len(all_playlist_ftrs)):
            data = {
                uid:{
